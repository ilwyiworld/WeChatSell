...
import com.yiworld.config.WechatAccountConfig;
import com.yiworld.dto.OrderDTO;
import com.yiworld.service.PushMessageService;
...
public class PushMessageServiceImpl implements PushMessageService {
    ...
    public void orderStatus(OrderDTO orderDTO) {
        ...
        templateMessage.getData().add(new WxMpTemplateData("keyword2", "18868812345"));
        ...
        templateMessage.getData().add(new WxMpTemplateData("remark", "欢迎再次光临！"));
        try {
